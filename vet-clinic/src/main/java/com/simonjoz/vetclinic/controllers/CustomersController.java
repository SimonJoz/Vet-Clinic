...
public class CustomersController {
    ...
    @ApiOperation("Method is used to create new appointment with specified doctor at certain date and time for customer with given id." +
    ...
    @ApiOperation("Method is used to cancel (delete) appointment with specified doctor at certain date and time for customer with given id." +
    ...
    public ResponseEntity<String> cancelAppointment(
        ...
        return new ResponseEntity<>("Appointment has been removed successfully.", HttpStatus.NO_CONTENT);
    }
